...
const typeIcon: Record<string, string> = { summary: '📊', low_stock: '📦', udhar: '💰', expiry: '⏰', order: '🚚', general: '🔔' };
        ...
        <div className="space-y-4 max-w-2xl">
            ...
            <div className="space-y-2">
                {items.map((n: any, i: number) => (
                    <motion.div key={n._id} initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.03 }}
                        className="wp-card p-4 flex gap-3" style={!n.isRead ? { borderLeft: '3px solid var(--brand-700)' } : {}}>
